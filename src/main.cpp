...
uint256 hashGenesisBlock("0x1521d97447ba80fd9a083a583f322a4a763c2e67b8006200df31184870aaa198");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520133695); // testcoin: starting difficulty is 1 / 2^12
...
{
    int64 nSubsidy = 2500000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 800000); // testcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // testcoin: 3.5 days
static const int64 nTargetSpacing = 60; // testcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf252c3c51044eb56d2160093c58a724911305c3da606eccfa728a3148c7cf75d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "EEn mooie dag in december";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 2500000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("16dec6a04f0075b62da6de519f4161b0b733f05dd3275c36ece86700a121d7b6cdfcc8f1cd4c8d4b71773dc8f93ac6171bca41164d2a569e20cfbdb448ed9e2536") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513675526;
        block.nBits    = 520133695;
        block.nNonce   = 4288111812;

        if (fTestNet)
        {
            block.nTime    = 1513675526;
            block.nNonce   = 3998542054;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe5219316d29fbf0eab0978f9f4f02422f2f8ecd463d595c00a8ee3bde2807ff1"));
        block.print();
